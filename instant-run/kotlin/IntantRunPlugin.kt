...
const val EXTENSION_NAME = "instantRunConfig"
const val TASK_NAME = "instantRunTask"
...
abstract class TemplatePlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.tasks.register(TASK_NAME, InstantRunTask::class.java) {
            it.tag.set(extension.tag)
            it.message.set(extension.message)
            it.outputFile.set(extension.outputFile)
        }
//        print("-----------------TemplatePlugin start apply----------------------")
    }
}
